...
long long int BT::Block::GetByteOffsetWithinPiece() { return byteOffsetWithinPiece; }
long long int BT::Block::GetPieceIndex() { return pieceIndex; }
long long int BT::Block::GetSize() { return size; }
...
std::vector<BT::Block> BT::Piece::GetBlocks() { return blocks; }

long long int BT::Piece::GetSize() { return size; }